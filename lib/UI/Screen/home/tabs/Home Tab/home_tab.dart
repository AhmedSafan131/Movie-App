          ...
          if (state is HomeTabLoadingState) {
            ...
            return SafeArea(
              ...
              children: [
                ...
                HomeGenresWidget(genre: 'Action',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Drama',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Adventure',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Mystery',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Documentary',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Thriller',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Animation',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Comedy',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Family',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Music',movies: state.moviesList,),
                HomeGenresWidget(genre: 'War',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Horror',movies: state.moviesList,),
                HomeGenresWidget(genre: 'Fantasy',movies: state.moviesList,),
