...
class AppStyles {
  ...
  static TextStyle bold20LightGrey = GoogleFonts.inter(
    fontSize: 20,
    fontWeight: FontWeight.bold,
  ...
  static TextStyle medium18Yellow = GoogleFonts.inter(
    fontSize: 18,
    fontWeight: FontWeight.w400,
    color: AppColors.yellowColor,
  );
  static TextStyle semiBold32White = GoogleFonts.inter(
    fontSize: 32,
    fontWeight: FontWeight.w700,
    color: AppColors.white,
  );
  static TextStyle semiBold22White = GoogleFonts.inter(
    fontSize: 32,
    fontWeight: FontWeight.w700,
    color: AppColors.white,
  );
  ...
  static TextStyle semiBoldAccentYellow = GoogleFonts.inter(
    fontSize: 16,
    fontWeight: FontWeight.w600,
